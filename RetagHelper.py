    ...
    "semesters": [
        {
            ...
            "courses": [
                {"id":"c1",  "code":"AE 103",  "name":"Historical Perspective of Aerospace Engg.",     "tag":"C", "newTag":"C", "credits":6, "grade":"AB"},
                {"id":"c2",  "code":"BB 101",  "name":"Biology",                                        "tag":"C", "newTag":"C", "credits":6, "grade":"BB"},
                {"id":"c3",  "code":"CH 117",  "name":"Chemistry Lab",                                  "tag":"C", "newTag":"C", "credits":3, "grade":"AB"},
                {"id":"c4",  "code":"GC 101",  "name":"Gender in the Workplace",                        "tag":"N", "newTag":"N", "credits":0, "grade":"PP"},
                {"id":"c5",  "code":"MA 105",  "name":"Calculus",                                       "tag":"C", "newTag":"C", "credits":8, "grade":"BB"},
                {"id":"c6",  "code":"MS 101",  "name":"Makerspace",                                     "tag":"C", "newTag":"C", "credits":8, "grade":"AB"},
        ...
        },
        {
            ...
            "courses": [
                ...
                {"id":"c11", "code":"HS 110",  "name":"Introduction to Psychology",                     "tag":"C", "newTag":"C", "credits":4, "grade":"BC"},
                {"id":"c12", "code":"MA 110",  "name":"Linear Algebra & Differential Equations",        "tag":"C", "newTag":"C", "credits":8, "grade":"BC"},
        ...
        },
        {
            ...
            "courses": [
                {"id":"c16", "code":"AE 223",  "name":"Thermodynamics and Propulsion",                  "tag":"C", "newTag":"C", "credits":6, "grade":"BB"},
                {"id":"c17", "code":"AE 227",  "name":"Solid Mechanics",                                "tag":"C", "newTag":"C", "credits":6, "grade":"BB"},
                {"id":"c18", "code":"AE 229",  "name":"Intro to Aerodynamics & Propulsion Lab",         "tag":"C", "newTag":"C", "credits":3, "grade":"AB"},
                {"id":"c19", "code":"AE 231",  "name":"Intro to Aerospace Structures & Control Lab",    "tag":"C", "newTag":"C", "credits":3, "grade":"AB"},
                {"id":"c20", "code":"AE 308",  "name":"Control Theory",                                 "tag":"C", "newTag":"C", "credits":6, "grade":"BB"},
                {"id":"c21", "code":"AE 410",  "name":"Navigation and Guidance",                        "tag":"D", "newTag":"D", "credits":6, "grade":"AB"},
                {"id":"c22", "code":"EC 101",  "name":"Economics",                                      "tag":"C", "newTag":"C", "credits":6, "grade":"CC"},
                ...
                {"id":"c25", "code":"SC 618",  "name":"Analytical and Geometric Dynamics",              "tag":"M", "newTag":"M", "credits":0, "grade":"BB"},
                {"id":"c26", "code":"SC 639",  "name":"Mathematical Structures for Control",            "tag":"M", "newTag":"M", "credits":6, "grade":"AB"},
            ]
        },
        {
            "id": "s4", "name": "Semester 4",
            "courses": [
                {"id":"c27", "code":"AE 233",  "name":"Control Systems Laboratory",                     "tag":"C", "newTag":"C", "credits":3, "grade":"AB"},
                {"id":"c28", "code":"AE 238",  "name":"Aerospace Structural Mechanics",                 "tag":"C", "newTag":"C", "credits":6, "grade":"BB"},
                {"id":"c29", "code":"AE 244",  "name":"Low Speed Aerodynamics",                         "tag":"C", "newTag":"C", "credits":6, "grade":"BC"},
                {"id":"c30", "code":"AE 246",  "name":"Aircraft Structures Laboratory",                 "tag":"C", "newTag":"C", "credits":3, "grade":"AA"},
                {"id":"c31", "code":"AE 248",  "name":"AI and Data Science",                            "tag":"C", "newTag":"C", "credits":6, "grade":"BC"},
                {"id":"c32", "code":"AE 686",  "name":"Guidance of Aerospace Vehicles",                 "tag":"T", "newTag":"T", "credits":0, "grade":"BB"},
                {"id":"c33", "code":"DE 250",  "name":"Design Thinking for Innovation",                 "tag":"C", "newTag":"C", "credits":6, "grade":"BB"},
                {"id":"c34", "code":"PH 111",  "name":"Introduction to Classical Physics",              "tag":"C", "newTag":"C", "credits":4, "grade":"CC"},
                {"id":"c35", "code":"SC 202",  "name":"Signals and Feedback Systems",                   "tag":"M", "newTag":"M", "credits":0, "grade":"BB"},
                {"id":"c36", "code":"SC 602",  "name":"Control of Nonlinear Dynamical Systems",         "tag":"SE","newTag":"SE","credits":0, "grade":"BC"},
            ]
        },
        {
            "id": "s5", "name": "Semester 5",
            "courses": [
                {"id":"c37", "code":"AE 219",  "name":"Supervised Learning",                            "tag":"T", "newTag":"T", "credits":0, "grade":"BC"},
                {"id":"c38", "code":"AE 339",  "name":"High Speed Aerodynamics",                        "tag":"C", "newTag":"C", "credits":6, "grade":"BB"},
                {"id":"c39", "code":"AE 341",  "name":"Flight Mechanics of Aircrafts and Spacecrafts",  "tag":"C", "newTag":"C", "credits":6, "grade":"BB"},
                {"id":"c40", "code":"AE 343",  "name":"Aerodynamics Laboratory",                        "tag":"C", "newTag":"C", "credits":3, "grade":"AA"},
                {"id":"c41", "code":"AE 344",  "name":"Aero Propulsion",                                "tag":"C", "newTag":"C", "credits":6, "grade":"BB"},
                {"id":"c42", "code":"AE 345",  "name":"Aircraft Propulsion Laboratory",                 "tag":"C", "newTag":"C", "credits":3, "grade":"BB"},
                {"id":"c43", "code":"AE 667",  "name":"Rotary Wing Aerodynamics",                       "tag":"D", "newTag":"D", "credits":6, "grade":"AA"},
                {"id":"c44", "code":"ENT617",  "name":"Tech-Opportunities Identification",              "tag":"HE","newTag":"HE","credits":0, "grade":"BB"},
                {"id":"c45", "code":"ME 781",  "name":"Statistical Machine Learning and Data Mining",   "tag":"M", "newTag":"M", "credits":0, "grade":"BC"},
                {"id":"c46", "code":"SC 301",  "name":"Linear and Nonlinear Systems",                   "tag":"M", "newTag":"M", "credits":6, "grade":"AB"},
            ]
        },
        {
